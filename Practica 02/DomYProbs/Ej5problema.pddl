(define (problem Ejercicio5)
	...
	(:INIT
		...
		(= (Cost) 0)
		(= (Points) 0)
		(= (ObtainedItems Princesa) 0)
		(= (ObtainedItems Principe) 0)
		(= (ObtainedItems Bruja) 0)
		(= (ObtainedItems Profesor) 0)
		(= (ObtainedItems DiCaprio) 0)
		(EmptyHand)
		(EmptyBag)
	)
	(:goal 
		(and (>= (Points) 50) (< (ObtainedItems Princesa) 3) (< (ObtainedItems Principe) 3) (< (ObtainedItems Bruja) 4) (< (ObtainedItems Profesor) 2) (< (ObtainedItems DiCaprio) 3))
	)
