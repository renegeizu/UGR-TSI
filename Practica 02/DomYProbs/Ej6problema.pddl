(define (problem Ejercicio6)
	...
	(:INIT
		...
		(PositionPlayer Jugador1 Map8)
		(OrientationPlayer Jugador1 Norte)
		(PositionPlayer Jugador2 Map18)
		(OrientationPlayer Jugador2 Sur)
		(Free Piedra)
		(Free Arena)
		...
		(= (Cost) 0)
		(= (Points) 0)
		(= (ObtainedItems Jugador1) 0)
		(= (ObtainedItems Jugador2) 0)
		(EmptyHand Jugador1)
		(EmptyBag Jugador1)
		(EmptyHand Jugador2)
		(EmptyBag Jugador2)
	...
	(:goal 
		(and (>= (Points) 50) (> (ObtainedItems Jugador1) 15) (> (ObtainedItems Jugador2) 15))
	)
